...
class TestAssignment4(unittest.TestCase):
    ...
    @number("1.1")
    def test_ex1_1(self):
        value = self.assignment4.ex1('test1234')
    ...
    @number("1.2")
    def test_ex1_2(self):
        value = self.assignment4.ex1('password123')
        self.assertEqual(False, value)
    ...
    @number("1.3")
    def test_ex1_3(self):
        value = self.assignment4.ex1('SuperPasswrd90')
        self.assertEqual(False, value)
    ...
    @number("1.4")
    def test_ex1_4(self):
        value = self.assignment4.ex1('letmein!')
        self.assertEqual(False, value)
    ...
    @number("1.6")
    def test_ex1_6(self):
        value = self.assignment4.ex1('InWard@1234')
        self.assertEqual(True, value)
    ...
    @number("1.7")
    def test_ex1_7(self):
        value = self.assignment4.ex1('Test3451')
        self.assertEqual(False, value)
    ...
    @number("1.8")
    def test_ex1_8(self):
        value = self.assignment4.ex1('AnandTech!892')
        self.assertEqual(True, value)
    ...
    @number("1.9")
    def test_ex1_9(self):
        value = self.assignment4.ex1('aaaaaaaaaaaaaa')
        self.assertEqual(False, value)
    ...
    def test_ex1_10(self):
        value = self.assignment4.ex1('12345!')
        self.assertEqual(False, value)
    ...
    @number("2.1")
    def test_ex2_1(self):
        value = self.assignment4.ex2('This is a test sentence!')
    ...
    @number("3.1")
    def test_ex3_1(self):
        value = self.assignment4.ex3('ex3_data.txt')
    ...
    @number("4.1")
    def test_ex4_1(self):
        value = self.assignment4.ex4(0.06)
    ...
    @number("4.2")
    def test_ex4_2(self):
        value = self.assignment4.ex4(0.1)
    ...
    @number("8.1")
    def test_ex8_1(self):
        value = self.assignment4.ex8(25, 75)
    ...
    @number("8.2")
    def test_ex8_2(self):
        value = self.assignment4.ex8(3, 13)
    ...
    @number("8.3")
    def test_ex8_3(self):
        value = self.assignment4.ex8(24, 62)
    ...
    @number("8.4")
    def test_ex8_4(self):
        value = self.assignment4.ex8(24, 48)
    ...
    @number("9.1")
    def test_ex9_1(self):
        value = self.assignment4.ex9('ex9_data.txt')
    ...
    def test_ex10_1(self):
        ...
        value = self.assignment4.ex10(data, 2)
    ...
    def test_ex12_1(self):
        value = self.assignment4.ex12(28)
    ...
    def test_ex12_2(self):
        value = self.assignment4.ex12(496)
    ...
    def test_ex13_1(self):
        value = self.assignment4.ex13(28)
        self.assertEqual(True, value)
    ...
    def test_ex13_2(self):
        value = self.assignment4.ex13(76)
        self.assertEqual(False, value)
    ...
    def test_ex13_3(self):
        value = self.assignment4.ex13(496)
        self.assertEqual(True, value)
    ...
    def test_ex13_4(self):
        value = self.assignment4.ex13(512)
        self.assertEqual(False, value)
    ...
    def test_ex14_1(self):
        ...
        value = self.assignment4.ex14(points)
    ...
    def test_ex15_1(self):
        ...
        self.assignment4.ex15(title, header, data, 'ex15_1.txt')
    ...
    def test_ex15_2(self):
        ...
        self.assignment4.ex15(title, header, data, 'ex15_2.txt')
    ...
    def test_ex15_3(self):
        ...
        self.assignment4.ex15(title, header, data, 'ex15_3.txt')
